...
import laser_blue_player from '../assets/images/png/Lasers/laserBlue16.png';
import laser_green_player from '../assets/images/png/Lasers/laserGreen10.png';
import laser_red_player from '../assets/images/png/Lasers/laserRed16.png';
...
export class BootGame extends Phaser.Scene {
	...
	preload(){
		...
		this.load.image('laser_blue_player', laser_blue_player);
		this.load.image('laser_green_player', laser_green_player);
		this.load.image('laser_red_player', laser_red_player);
